...
function onMessageHandler (target, context, msg, self) {
  ...
  if (context.username==omdriver) {
    hostname=om;
  }
  else if (context.username==nomdriver) {
    hostname=nom;
  }

  if (roombaState&&hostname) {
    let n=a[0][0];
    if (commands.includes(n)) {
